...
/**
 * @file OutdoorPvPNA.cpp
 * @brief 纳格兰户外PvP系统实现 - 哈拉战斗
 *
 * 本模块实现了纳格兰地区哈拉城的争夺战机制：
 * - 玩家需要击杀守卫才能开始占领
 * - 四个双足飞龙栖木提供轰炸能力
 * - 占领哈拉后获得墓地使用权和阵营增益
 * - 击杀敌方玩家获得奖励印记
...
uint32 const NA_CREDIT_MARKER = 24867; // 击杀玩家的积分标记ID
uint32 const NA_GUARDS_MAX = 15;       // 哈拉守卫最大数量
uint32 const NA_BUFF_ZONE = 3518;      // 纳格兰区域ID
uint32 const NA_HALAA_GRAVEYARD = 993;  // 哈拉墓地ID
uint32 const NA_HALAA_GRAVEYARD_ZONE = 3518; // 哈拉墓地所在区域ID（需要使用区域ID而非区域名称）
uint32 const NA_RESPAWN_TIME = 3600000; // 击败所有守卫后的占领时间窗口（1小时，单位毫秒）
uint32 const NA_GUARD_CHECK_TIME = 500; // 守卫存活检查间隔（每半秒检查一次）
uint32 const FLIGHT_NODES_NUM = 4;      // 飞行节点数量
...
{
    { 182267, 530, { -1815.8000f, 8036.5100f, -26.2354f, -2.897250f }, { 0.0f, 0.0f, 0.992546f, -0.121869f } }, //ALLY_ROOST_SOUTH (联盟南栖木)
    { 182280, 530, { -1507.9500f, 8132.1000f, -19.5585f, -1.343900f }, { 0.0f, 0.0f, 0.622515f, -0.782608f } }, //ALLY_ROOST_WEST (联盟西栖木)
    { 182281, 530, { -1384.5200f, 7779.3300f, -11.1663f, -0.575959f }, { 0.0f, 0.0f, 0.284015f, -0.958820f } }, //ALLY_ROOST_NORTH (联盟北栖木)
    { 182282, 530, { -1650.1100f, 7732.5600f, -15.4505f, -2.809980f }, { 0.0f, 0.0f, 0.986286f, -0.165048f } }, //ALLY_ROOST_EAST (联盟东栖木)

    { 182222, 530, { -1825.4022f, 8039.2602f, -26.0800f, -2.897250f }, { 0.0f, 0.0f, 0.992546f, -0.121869f } }, //HORDE_BOMB_WAGON_SOUTH (部落南炸药车)
    { 182272, 530, { -1515.3700f, 8136.9100f, -20.4200f, -1.343900f }, { 0.0f, 0.0f, 0.622515f, -0.782608f } }, //HORDE_BOMB_WAGON_WEST (部落西炸药车)
    { 182273, 530, { -1377.9500f, 7773.4400f, -10.3100f, -0.575959f }, { 0.0f, 0.0f, 0.284015f, -0.958820f } }, //HORDE_BOMB_WAGON_NORTH (部落北炸药车)
    { 182274, 530, { -1659.8700f, 7733.1500f, -15.7500f, -2.809980f }, { 0.0f, 0.0f, 0.986286f, -0.165048f } }, //HORDE_BOMB_WAGON_EAST (部落东炸药车)

    { 182266, 530, { -1815.8000f, 8036.5100f, -26.2354f, -2.897250f }, { 0.0f, 0.0f, 0.992546f, -0.121869f } }, //DESTROYED_ALLY_ROOST_SOUTH (被摧毁的联盟南栖木)
    { 182275, 530, { -1507.9500f, 8132.1000f, -19.5585f, -1.343900f }, { 0.0f, 0.0f, 0.622515f, -0.782608f } }, //DESTROYED_ALLY_ROOST_WEST (被摧毁的联盟西栖木)
    { 182276, 530, { -1384.5200f, 7779.3300f, -11.1663f, -0.575959f }, { 0.0f, 0.0f, 0.284015f, -0.958820f } }, //DESTROYED_ALLY_ROOST_NORTH (被摧毁的联盟北栖木)
    { 182277, 530, { -1650.1100f, 7732.5600f, -15.4505f, -2.809980f }, { 0.0f, 0.0f, 0.986286f, -0.165048f } }  //DESTROYED_ALLY_ROOST_EAST (被摧毁的联盟东栖木)
};

/**
 * @brief 联盟控制时的游戏对象配置
 *
 * 当部落进攻、联盟控制哈拉时生成的游戏对象：
 * - 部落双足飞龙栖木（可被摧毁）
 * - 联盟炸药车（用于摧毁栖木）
 * - 被摧毁的部落栖木
 */
...
{
    { 182301, 530, { -1815.8000f, 8036.5100f, -26.2354f, -2.897250f }, { 0.0f, 0.0f, 0.992546f, -0.121869f } }, //HORDE_ROOST_SOUTH (部落南栖木)
    { 182302, 530, { -1507.9500f, 8132.1000f, -19.5585f, -1.343900f }, { 0.0f, 0.0f, 0.622515f, -0.782608f } }, //HORDE_ROOST_WEST (部落西栖木)
    { 182303, 530, { -1384.5200f, 7779.3300f, -11.1663f, -0.575959f }, { 0.0f, 0.0f, 0.284015f, -0.958820f } }, //HORDE_ROOST_NORTH (部落北栖木)
    { 182304, 530, { -1650.1100f, 7732.5600f, -15.4505f, -2.809980f }, { 0.0f, 0.0f, 0.986286f, -0.165048f } }, //HORDE_ROOST_EAST (部落东栖木)

    { 182305, 530, { -1825.4022f, 8039.2602f, -26.0800f, -2.897250f }, { 0.0f, 0.0f, 0.992546f, -0.121869f } }, //ALLY_BOMB_WAGON_SOUTH (联盟南炸药车)
    { 182306, 530, { -1515.3700f, 8136.9100f, -20.4200f, -1.343900f }, { 0.0f, 0.0f, 0.622515f, -0.782608f } }, //ALLY_BOMB_WAGON_WEST (联盟西炸药车)
    { 182307, 530, { -1377.9500f, 7773.4400f, -10.3100f, -0.575959f }, { 0.0f, 0.0f, 0.284015f, -0.958820f } }, //ALLY_BOMB_WAGON_NORTH (联盟北炸药车)
    { 182308, 530, { -1659.8700f, 7733.1500f, -15.7500f, -2.809980f }, { 0.0f, 0.0f, 0.986286f, -0.165048f } }, //ALLY_BOMB_WAGON_EAST (联盟东炸药车)

    { 182297, 530, { -1815.8000f, 8036.5100f, -26.2354f, -2.897250f }, { 0.0f, 0.0f, 0.992546f, -0.121869f } }, //DESTROYED_HORDE_ROOST_SOUTH (被摧毁的部落南栖木)
    { 182298, 530, { -1507.9500f, 8132.1000f, -19.5585f, -1.343900f }, { 0.0f, 0.0f, 0.622515f, -0.782608f } }, //DESTROYED_HORDE_ROOST_WEST (被摧毁的部落西栖木)
    { 182299, 530, { -1384.5200f, 7779.3300f, -11.1663f, -0.575959f }, { 0.0f, 0.0f, 0.284015f, -0.958820f } }, //DESTROYED_HORDE_ROOST_NORTH (被摧毁的部落北栖木)
    { 182300, 530, { -1650.1100f, 7732.5600f, -15.4505f, -2.809980f }, { 0.0f, 0.0f, 0.986286f, -0.165048f } }  //DESTROYED_HORDE_ROOST_EAST (被摧毁的部落东栖木)
};

/**
 * @brief 部落控制哈拉时的NPC配置
 *
 * 包含部落控制哈拉时生成的NPC（商人和守卫）
 */
creature_type const HordeControlNPCs[NA_CONTROL_NPC_NUM] =
{
    { 18816, 530, { -1523.92f, 7951.76f, -17.6942f, 3.51172f } }, // 部落商人
    { 18821, 530, { -1527.75f, 7952.46f, -17.6948f, 3.99317f } }, // 部落军需官
    { 21474, 530, { -1520.14f, 7927.11f, -20.2527f, 3.39389f } }, // 部落军官
    { 21484, 530, { -1524.84f, 7930.34f, -20.1820f, 3.64050f } }, // 部落军官
    { 21483, 530, { -1570.01f, 7993.80f, -22.4505f, 5.02655f } }, // 部落军官
    { 18192, 530, { -1654.06f, 8000.46f, -26.5900f, 3.37000f } }, // 哈拉守卫
    { 18192, 530, { -1487.18f, 7899.10f, -19.5300f, 0.95400f } }, // 哈拉守卫
    { 18192, 530, { -1480.88f, 7908.79f, -19.1900f, 4.48500f } }, // 哈拉守卫
    { 18192, 530, { -1540.56f, 7995.44f, -20.4500f, 0.94700f } }, // 哈拉守卫
    { 18192, 530, { -1546.95f, 8000.85f, -20.7200f, 6.03500f } }, // 哈拉守卫
    { 18192, 530, { -1595.31f, 7860.53f, -21.5100f, 3.74700f } }, // 哈拉守卫
    { 18192, 530, { -1642.31f, 7995.59f, -25.8000f, 3.31700f } }, // 哈拉守卫
    { 18192, 530, { -1545.46f, 7995.35f, -20.6300f, 1.09400f } }, // 哈拉守卫
    { 18192, 530, { -1487.58f, 7907.99f, -19.2700f, 5.56700f } }, // 哈拉守卫
    { 18192, 530, { -1651.54f, 7988.56f, -26.5289f, 2.98451f } }, // 哈拉守卫
    { 18192, 530, { -1602.46f, 7866.43f, -22.1177f, 4.74729f } }, // 哈拉守卫
    { 18192, 530, { -1591.22f, 7875.29f, -22.3536f, 4.34587f } }, // 哈拉守卫
    { 18192, 530, { -1550.60f, 7944.45f, -21.6300f, 3.55900f } }, // 哈拉守卫
    { 18192, 530, { -1545.57f, 7935.83f, -21.1300f, 3.44800f } }, // 哈拉守卫
    { 18192, 530, { -1550.86f, 7937.56f, -21.7000f, 3.80100f } }  // 哈拉守卫
};

/**
 * @brief 联盟控制哈拉时的NPC配置
 *
 * 包含联盟控制哈拉时生成的NPC（商人和守卫）
 */
creature_type const AllianceControlNPCs[NA_CONTROL_NPC_NUM] =
{
    { 18817, 530, { -1591.18f, 8020.39f, -22.2042f, 4.59022f } }, // 联盟商人
    { 18822, 530, { -1588.00f, 8019.00f, -22.2042f, 4.06662f } }, // 联盟军需官
    { 21485, 530, { -1521.93f, 7927.37f, -20.2299f, 3.24631f } }, // 联盟军官
    { 21487, 530, { -1540.33f, 7971.95f, -20.7186f, 3.07178f } }, // 联盟军官
    { 21488, 530, { -1570.01f, 7993.80f, -22.4505f, 5.02655f } }, // 联盟军官
    { 18256, 530, { -1654.06f, 8000.46f, -26.5900f, 3.37000f } }, // 哈拉守卫
    { 18256, 530, { -1487.18f, 7899.10f, -19.5300f, 0.95400f } }, // 哈拉守卫
    { 18256, 530, { -1480.88f, 7908.79f, -19.1900f, 4.48500f } }, // 哈拉守卫
    { 18256, 530, { -1540.56f, 7995.44f, -20.4500f, 0.94700f } }, // 哈拉守卫
    { 18256, 530, { -1546.95f, 8000.85f, -20.7200f, 6.03500f } }, // 哈拉守卫
    { 18256, 530, { -1595.31f, 7860.53f, -21.5100f, 3.74700f } }, // 哈拉守卫
    { 18256, 530, { -1642.31f, 7995.59f, -25.8000f, 3.31700f } }, // 哈拉守卫
    { 18256, 530, { -1545.46f, 7995.35f, -20.6300f, 1.09400f } }, // 哈拉守卫
    { 18256, 530, { -1487.58f, 7907.99f, -19.2700f, 5.56700f } }, // 哈拉守卫
    { 18256, 530, { -1651.54f, 7988.56f, -26.5289f, 2.98451f } }, // 哈拉守卫
    { 18256, 530, { -1602.46f, 7866.43f, -22.1177f, 4.74729f } }, // 哈拉守卫
    { 18256, 530, { -1591.22f, 7875.29f, -22.3536f, 4.34587f } }, // 哈拉守卫
    { 18256, 530, { -1603.75f, 8000.36f, -24.1800f, 4.51600f } }, // 哈拉守卫
    { 18256, 530, { -1585.73f, 7994.68f, -23.2900f, 4.43900f } }, // 哈拉守卫
    { 18256, 530, { -1595.50f, 7991.27f, -23.5300f, 4.73800f } }  // 哈拉守卫
};
